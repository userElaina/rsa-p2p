...
class TCPp2p(TCPserver):
    ...
    def checkf(self,b:bytes,addr:tuple)->int:
        ...
        if b[2] not in self.gsend:
            ...
            code=self.connect(b[2],_addr,PASSIVE)
        self.gaddr[addr]=b[2]
        self.gname[b[2]]=addr
        return code

    def connect(self,gname:str,gsaddr:tuple=None,proactive:str=PROACTIVE)->int:
        ...
        try:
            ...
            return ERROR_404
        gs.setsalt(self.ip+'.'+str(self.addr[1])+'.'+proactive)
